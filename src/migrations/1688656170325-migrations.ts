...
export class Migrations1688656170325 implements MigrationInterface {
    name = 'Migrations1688656170325'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcements" ("id" SERIAL NOT NULL, "model" character varying(60) NOT NULL, "type" character varying(150) NOT NULL, "description" character varying, "km" integer NOT NULL, "year" integer NOT NULL, "default_img" character varying, "images" text NOT NULL, "price" double precision NOT NULL, "isActive" boolean NOT NULL DEFAULT 'true', "userId" integer, CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`);
